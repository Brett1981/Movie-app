...
namespace MovieDB
{
    ...
    {
        //string connectionString = @"Data Source=DESKTOP-9MBM301\SQLEXPRESS;Initial Catalog=movieDB;Integrated Security=True";
        //string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Malik\Desktop\3 semester\C#\MovieDB\MovieDB\MovieDB\movieDB.mdf;Integrated Security=True";
        //@"Server=DESKTOP-9MBM301\SQLEXPRESS;Database=movieDB;Integrated Security=true";
            ...
            string genre, int runtime)
        {
            ...
            try {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    using (Stream inStream = File.Open(@"C: \Users\Malik\Desktop\3 semester\C#\MovieDB\MovieDB\MovieDB\1.jpg", FileMode.Open))
                    {
        ...
        public string insertToCast(int id, string character, string name, string profilePath)
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    using (Stream inStream = File.Open(@"C: \Users\Malik\Desktop\3 semester\C#\MovieDB\MovieDB\MovieDB\2.jpg", FileMode.Open))
                    {
                        myFile = new byte[inStream.Length];
                        for (int i = 0; i < inStream.Length; i++)
                            myFile[i] = ((byte)inStream.ReadByte());
